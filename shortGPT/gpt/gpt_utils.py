...
def gpt3Turbo_completion(chat_prompt="", system="You are an AI that can give the answer to anything", temp=0.7, model=os.getenv('OPENAI_MODEL', 'gpt-3.5-turbo-1106'), max_tokens=1000, remove_nl=True, conversation=None):
